<header data-elementor-type="header" data-elementor-id="38" class="elementor elementor-38 elementor-location-header"
    ...
    <div class="elementor-element elementor-element-7240710 e-flex e-con-boxed e-con e-parent" data-id="7240710"
        data-element_type="container">
        <div class="e-con-inner">
            <div class="elementor-element elementor-element-7e633be e-con-full e-flex e-con e-child" data-id="7e633be"
                data-element_type="container">
            ...
            <div class="elementor-element elementor-element-2495823 e-con-full e-flex e-con e-child" data-id="2495823"
                data-element_type="container">
                <div class="elementor-element elementor-element-b4929b7 elementor-nav-menu--stretch elementor-nav-menu--dropdown-tablet elementor-nav-menu__text-align-aside elementor-nav-menu--toggle elementor-nav-menu--burger elementor-widget elementor-widget-nav-menu"
                    data-id="b4929b7" data-element_type="widget"
                    ...
                    <div class="elementor-widget-container">
                        <nav aria-label="Menu"
                            ...
                            <ul id="menu-1-b4929b7" class="elementor-nav-menu">
                                ...
                                <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-35">
                                    <a href="{{ route('risk-assessment') }}" class="elementor-item">Risk Assessment</a>
                                </li>
                        ...
                        <div class="elementor-menu-toggle" role="button" tabindex="0" aria-label="Menu Toggle"
                            ...
                            <svg aria-hidden="true" role="presentation"
                                class="elementor-menu-toggle__icon--open e-font-icon-svg e-fas-bars"
                                viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M16 132h416c8.837 0 16-7.163 16-16V76c0-8.837-7.163-16-16-16H16C7.163 60 0 67.163 0 76v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16z">
                                </path>
                            </svg><svg aria-hidden="true" role="presentation"
                                class="elementor-menu-toggle__icon--close e-font-icon-svg e-fas-times"
                ...
                <div class="elementor-element elementor-element-7866c00 elementor-hidden-mobile elementor-widget elementor-widget-button"
                    data-id="7866c00" data-element_type="widget" data-widget_type="button.default">
                    <div class="elementor-widget-container">
