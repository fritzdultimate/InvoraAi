    ...
    <div class="dashboard-main-body">
        <div class="hidden flex-wrap items-center justify-between gap-2 mb-6">
            ...
            <ul class="flex items-center gap-[6px]">
                ...
                <a href="index.html" class="flex items-center gap-2 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover:text-primary-600">
                    <iconify-icon icon="solar:home-smile-angle-outline" class="icon text-lg"></iconify-icon>
                    Dashboard
                </a>
                </li>
                <li class="text-neutral-600 dark:text-white">-</li>
                <li class="text-neutral-600 font-medium dark:text-white">View Profile</li>
            </ul>
        </div>
                ...
                <div class="user-grid-card relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden bg-white dark:bg-neutral-700 h-full">
                    ...
                    <div class="pb-6 ms-6 mb-6 me-6 -mt-[100px]">
                        <div class="text-center border-b border-neutral-200 dark:border-neutral-600">
                            <img src="{{ asset('assets/images/user-grid/user-grid-img13.png') }}" alt="" class="border br-white border-width-2-px w-200-px h-[200px] rounded-full object-fit-cover mx-auto">
                            <h6 class="mb-0 mt-4 capitalize">{{ auth()->user()->firstname }} {{ auth()->user()->lastname }}</h6>
                        ...
                        <div class="mt-6">
                            ...
                            <ul>
                                <li class="flex items-center gap-1 mb-3">
                                    ...
                                    <span class="w-[70%] text-secondary-light font-medium">: {{ auth()->user()->firstname }} {{ auth()->user()->lastname }}</span>
                                </li>
                                <li class="flex items-center gap-1 mb-3">
                                ...
                                @if (auth()->user()->phone_number)
                                    <li class="flex items-center gap-1 mb-3">
                                        ...
                                        <span class="w-[70%] text-secondary-light font-medium">: {{ auth()->user()->phone_number }}</span>
                                    </li>
                                @endif
                            </ul>
                        </div>
                        ...
                        <div class="hidden" id="notification-password" role="tabpanel" aria-labelledby="notification-password-tab">
                            <div class="form-switch switch-primary py-3 px-4 border rounded-lg relative mb-4">
                                ...
                                <div class="flex items-center gap-3 justify-between">
                                    <span class="form-check-label line-height-1 font-medium text-secondary-light">
                                        2-Factor Auth
                                    </span>
